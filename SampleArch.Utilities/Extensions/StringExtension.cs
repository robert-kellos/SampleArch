...
namespace SampleArch.Utilities.Extensions
{
    /// <summary>
    ///     StringExtension
    /// </summary>
    public static class StringExtension
    {
        ...
        public static string GetDateTimeStringIso(this DateTime date)
        {
            ...
            {
                Audit.Log.Error("Exception :: Get ISO date-time string", e);
            }
        ...
        public static Bitmap BitmapFromBase64(string base64)
        {
            ...
            {
                Audit.Log.Error("Exception :: pushing base64 string to memory-stream bitmap", e);
        ...
        public static string RemoveTextBetween(this string input, string startDelimiter, string endDelimiter)
        {
            ...
            {
                Audit.Log.Error("Exception :: Removing text between delimiters", e);
            }
        ...
        public static string RemoveLastSeperator(this string input)
        {
            ...
            {
                Audit.Log.Error("Exception :: Removing last separator from string", e);
            }
        ...
        /// <returns></returns>
        public static string ReplaceWith(this string source, string from, string to, StringComparison comparison)
        {
            //============================================================================
            // Do nothing when nothing is found.
            //============================================================================
            var found = source.IndexOf(from, 0, comparison);
            ...
            //============================================================================
            // Allocate space for new string containing replacements.
            //============================================================================
            var newString = new StringBuilder(source.Length);
            ...
            while (found >= 0)
            {
                var moveForward = length + found;

                newString.Append(source.Substring(index, found - index));
                newString.Append(to);

                index = moveForward;

                found = source.IndexOf(@from, index, comparison);
            }

            newString.Append(source.Substring(index));
